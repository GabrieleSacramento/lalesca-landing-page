...
export default function Contact() {
    return (
        <section className="bg-[#FFFFFF] min-h-[796px] lg:h-[796px] flex items-center py-8 lg:py-0" id="contato">
            <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center">
                    ...
                    <div className="flex flex-col">
                        {/* Heading */}
                        <h2
                            className="text-xl sm:text-2xl lg:text-3xl text-[#B29671] font-normal mb-6 sm:mb-8"
                        ...
                        <div className="flex items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
                            {/* Map Pin Icon */}
                            <MapPin className="w-6 h-6 sm:w-8 sm:h-8 text-[#B29671] flex-shrink-0 mt-1" />
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center rounded-md bg-[#B29671] px-6 sm:px-8 py-3 sm:py-2.5 text-xs sm:text-sm lg:text-base font-normal text-white whitespace-nowrap w-fit lg:ml-8 min-h-[44px] sm:min-h-0 transition-opacity hover:opacity-90 active:opacity-75"
                            style={{ fontFamily: 'var(--font-archivo), sans-serif' }}
                        >
                            ENTRE EM CONTATO
                        </a>
                    ...
                    <div className="w-full h-full order-first lg:order-last">
                        <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[600px] rounded-lg overflow-hidden">
                            <iframe
