...
export default function Hero() {
    return (
        <section className="relative h-screen flex items-center overflow-hidden">
            ...
            {/* Content */}
            <div className="relative z-10 w-full h-full flex items-center px-4 sm:px-6 lg:px-8 lg:px-12 xl:px-16 py-12 lg:py-20">
                <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-0 items-center h-full">
                    ...
                    <div className="lg:w-full lg:max-w-none text-left flex flex-col justify-center h-full">
                        {/* Professional Title */}
                        <p
                            className="text-sm lg:text-base text-[#b29671] uppercase tracking-wide mb-[22px]"
                        ...
                        {/* Main Name */}
                        <h1
                            className="text-3xl lg:text-5xl xl:text-6xl text-white font-normal italic leading-none whitespace-nowrap mb-[22px]"
                        ...
                        <div className="relative mb-[140px]">
                            <p
                                className="text-base lg:text-lg text-white leading-relaxed max-w-full lg:max-w-[90%] relative z-10"
                                style={{ fontFamily: 'var(--font-archivo), sans-serif' }}
                            >
                        ...
                        <div className="flex flex-col sm:flex-row gap-[54px] relative z-10">
                            <a
                                ...
                                className="inline-flex items-center justify-center rounded-md bg-[#a87246] px-6 py-2 text-sm font-normal text-white whitespace-nowrap"
                                style={{ fontFamily: 'var(--font-archivo), sans-serif' }}
                            >
                                ENTRE EM CONTATO
                            </a>
